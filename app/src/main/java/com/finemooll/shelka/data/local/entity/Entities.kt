...
enum class TurnWordResultStatus { SHOWN, GUESSED, SKIPPED }
...
@Entity(
    ...
    foreignKeys = [
        ...
        ForeignKey(PlayerEntity::class, ["id"], ["explainerPlayerId"], onDelete = ForeignKey.NO_ACTION),
        ForeignKey(PlayerEntity::class, ["id"], ["guesserPlayerId"], onDelete = ForeignKey.NO_ACTION),
    ],
